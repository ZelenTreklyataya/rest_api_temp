...
use super::models::{CreateEnrtyData, UpdateEntryData};
...
async fn create_entry(data: web::Data<AppState>, param_obj: web::Json<CreateEnrtyData>) -> impl Responder{
